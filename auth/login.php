...
<body class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-indigo-600 via-purple-600 to-fuchsia-500 px-4 py-10">

<div class="absolute -top-16 -right-16 w-72 h-72 bg-white/20 rounded-full blur-3xl float-slow"></div>
<div class="absolute bottom-0 left-0 w-80 h-80 bg-indigo-300/30 rounded-full blur-3xl float-slow" style="animation-delay:2s"></div>
